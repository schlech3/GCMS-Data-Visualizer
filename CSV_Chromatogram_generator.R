...
#-------------------------- Inputs -----------------------------
Filefolder <- 'C:/MSU/Viridiflorol project/ChromatogramData/MS Supp figures/' #Folder where .csv's are located
...
YourPlot <- c('20241008_220316_V4','TIC'
              )
...
xrange <- c(3.5, 7) #Pick x-axes range
