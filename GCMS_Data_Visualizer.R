...
InputFileFolder <- 'C:/MSU/Coding/Stacked_Chromatogram_Generator/20230701/'    #Folder where .csv's are located
...
LineColors <- c('blue', 'orange','yellow','navy','darkgreen','red')    #Put in order of YourPlot variable. For pretty hexadecimals https://coolors.co/156064-00c49a-f8e16c-ffc2b4-fb8f67
...
plotname <- 'TEST.png'      #Name the file. please include the type of file (.jpg .png, .svg). It will save in the same  Filefolder as input data.

OutputFileFolder <- 'C:/MSU/Coding/Stacked_Chromatogram_Generator/20230701/'    #Folder where .csv's are located
